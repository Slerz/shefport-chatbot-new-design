...
const chatScenario = (() => {
  ...
  addState({
    ...
    messages: [
      {
        type: 'text',
        value: "Привет! 👋 Я Виктория, виртуальный консультант команды «ШефПорт»",
      },
      {
        type: 'text',
        value: "Готова ответить на любой ваш вопрос о франшизе наших рыбных магазинов",
      },
      {
        type: 'text',
        value: "У нас уже более 100 работающих магазинов по всей России, и мы продолжаем развиваться!",
      },
    ],
    options: [
